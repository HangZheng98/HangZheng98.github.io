...
-  B. Li, F. Cheng, **H. Zheng** *, Z. Shi, and C. Zhou, "Structural-missing tensor completion for robust DOA estimation with sensor failure," IET Signal Process., 2023. (*corresponding author)
